                    ...
                    <div class="col-md-10 search-permission" style="min-height: unset;">
                        ...
                        <div id="available-permissions" style="margin-top: 20px;">
                            ...
                            <div class="get-available-permissions">
                                ...
                                <div>
                                    <input type="checkbox" name="permissions[{{ $perm->id }}]" value="{{ $perm->id }}" id="perm_{{ $perm->id }}" {{ is_array(old('permissions')) && in_array($perm->id, old('permissions')) ? 'checked' : '' }} /> <label style="margin-left:20px;" for="perm_{{ $perm->id }}">{{ $perm->name }}</label>
                                </div>
                                @endforeach
                                @else
