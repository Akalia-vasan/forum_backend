...
@section('title', 'My Task' . ' | ' . 'My Posts')
...
<li class="breadcrumb-menu">
    <div class="btn-group" role="group" aria-label="Button group">
        <div class="dropdown">
            ...
            <a class="dropdown-item" href="{{ route('auth.post.create') }}">Create Post</a>
            </div>
        </div><!--dropdown-->
        ...
        <div class="row mt-4">
            <div class="col">
                <div class="table-responsive" style="overflow-y:visible;overflow-x:visible;">
                    <table class="table" id="pages-table" data-ajax_url="{{ route("auth.post.get") }}">
                        <thead>
                            <tr>
                                <th>Content</th>
                                <th>Status</th>
